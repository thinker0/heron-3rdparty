...
public final class AutoHDFSCommand {
    private static final Logger LOG = LoggerFactory.getLogger(org.apache.storm.hdfs.security.AutoHDFSCommand.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        org.apache.storm.hdfs.security.AutoHDFS autoHdfs = new org.apache.storm.hdfs.security.AutoHDFS();

    ...
    private class KafkaSpoutConsumerRebalanceListener implements ConsumerRebalanceListener {
        ...
        private long doSeek(TopicPartition newTp, OffsetAndMetadata committedOffset) {
            ...
            if (committedOffset != null) {
                ...
                if (firstPollOffsetStrategy.equals(FirstPollOffsetStrategy.EARLIEST) || firstPollOffsetStrategy.equals(
                    FirstPollOffsetStrategy.UNCOMMITTED_EARLIEST)) {
                    consumer.seekToBeginning(Collections.singleton(newTp));
                } else if (firstPollOffsetStrategy.equals(FirstPollOffsetStrategy.LATEST) || firstPollOffsetStrategy.equals(
                    FirstPollOffsetStrategy.UNCOMMITTED_LATEST)) {
                    consumer.seekToEnd(Collections.singleton(newTp));
                }
            }

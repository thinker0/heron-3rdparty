...
public class FieldNameBasedTupleToKafkaMapper<K, V> implements TupleToKafkaMapper<K, V> {
    ...
    private final String boltKeyField;
    private final String boltMessageField;
    ...
    public FieldNameBasedTupleToKafkaMapper(String boltKeyField, String boltMessageField) {
        this.boltKeyField = boltKeyField != null ? boltKeyField : BOLT_KEY;
        this.boltMessageField = boltMessageField != null ? boltMessageField : BOLT_MESSAGE;
    }

    public String getBoltKeyField() {
        return boltKeyField;
    }

    public String getBoltMessageField() {
        return boltMessageField;
    }

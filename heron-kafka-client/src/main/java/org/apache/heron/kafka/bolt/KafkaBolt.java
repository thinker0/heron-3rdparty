...
import org.apache.heron.kafka.bolt.mapper.TupleToKafkaMapper;
import org.apache.heron.kafka.bolt.selector.KafkaTopicSelector;
import org.apache.heron.topology.base.BaseTickTupleAwareRichBolt;
...
public class KafkaBolt<K, V> extends BaseTickTupleAwareRichBolt {
    ...
    /**
     * KafkaBolt#setFireAndForget(boolean) for more details on this.
     */
    private boolean fireAndForget = false;
    /**
     * KafkaBolt#setAsync(boolean) for more details on this.
     */

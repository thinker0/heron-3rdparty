...
public interface FailHandler extends Serializable {
     ...
     * {@link #shouldReplay(KafkaMessageId)} indicates it should *not* be replayed.
     *
     * @param id      The failed id.
     ...
     * {@link nl.minvenj.nfi.storm.kafka.KafkaSpout#open(Map, org.apache.heron.api.topology.TopologyContext, org.apache.heron.api.spout.SpoutOutputCollector)}

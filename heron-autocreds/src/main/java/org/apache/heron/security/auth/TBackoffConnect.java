...
import org.apache.heron.utils.StormBoundedExponentialBackoffRetry;
...
public class TBackoffConnect {
    ...
    private void retryNext(TTransportException ex) {
        ...
        try {
            ...
            LOG.debug("Failed to connect. Retrying... (" + Integer.toString(completedRetries) + ") in " + Long
                .toString(sleeptime) + "ms");

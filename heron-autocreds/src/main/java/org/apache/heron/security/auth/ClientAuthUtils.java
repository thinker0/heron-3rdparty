...
import org.apache.heron.generated.WorkerToken;
import org.apache.heron.generated.WorkerTokenInfo;
import org.apache.heron.generated.WorkerTokenServiceType;
import org.apache.heron.shade.org.apache.commons.codec.binary.Hex;
import org.apache.heron.utils.ObjectReader;
...
public class ClientAuthUtils {
     ...
     * @return the plugin
     */
    public static IGroupMappingServiceProvider getGroupMappingServiceProviderPlugin(
     ...
     */
    public static Collection<INimbusCredentialPlugin> getNimbusAutoCredPlugins(
        Map<String, Object> conf) {
        try {
     ...
     */
    public static Subject populateSubject(
        Subject subject, Collection<IAutoCredentials> autos, Map<String, String> credentials) {
        try {
            if (subject == null) {
                subject = new Subject();
            }

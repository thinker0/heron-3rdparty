 ...
 *
 * <p>``` storm -c nimbus.authorization.class=org.apache.heron.security.auth.NoopAuthorizer ... ```
 *
 * <p>You could also specify it via storm.yaml:
 *
 * <p>```yaml nimbus.authorization.class: org.apache.heron.security.auth.NoopAuthorizer ```
 */
